$(function() {
	$(window).scroll(function(){
      ...
      //matchMedia可依設定判斷畫面寬度
      const media_display = window.matchMedia("(min-width: 1440px)");
      media_display.addListener(resizeWidth);
      resizeWidth(media_display);

      function resizeWidth(media){
